            ...
            <form id="registration-form" class="header__popup-inner">
                <div class="header__registration-input">
                    <div class="header__input-search input-popup">
                        <input class="header__input-search-input input-popup__input" type="email" name="login"
                ...
                <div class="header__registration-input">
                    <div class="header__input-search input-popup">
                        <input class="header__input-search-input input-popup__input" type="text" name="name"
                ...
                <div class="header__registration-input">
                    <div class="header__input-search input-popup">
                        <input class="header__input-search-input input-popup__input" type="text" name="phone"
                ...
                <div class="header__registration-input">
                    <div class="header__input-search input-popup">
                        <input class="header__input-search-input input-popup__input" type="password" maxlength="20" minlength="8" data-input-move name="password">
                ...
                <div class="header__registration-input">
                    <div class="header__input-search input-popup">
                        <input class="header__input-search-input input-popup__input" type="password" maxlength="20" minlength="8" data-input-move name="repeat-password">
