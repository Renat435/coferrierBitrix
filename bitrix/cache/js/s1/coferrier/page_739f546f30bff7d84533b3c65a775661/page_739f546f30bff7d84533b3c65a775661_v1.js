...
; /* Start:"a:4:{s:4:"full";s:75:"/local/components/custom/basket/templates/.default/script.js?16874975349018";s:6:"source";s:60:"/local/components/custom/basket/templates/.default/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
BX.ready(function () {
    ...
    document.querySelector('.basket__info-order-button').addEventListener('click', function () {
        ...
        document.querySelectorAll('.basket__info-list-item').forEach(item => {
            ...
            let name = item.querySelector('.basket__info-list-item-info-name').innerHTML;
            let count = item.querySelector('.basket__info-list-item-info-price-block-counter').innerHTML;
...
/* End */
;; /* /local/components/custom/basket/templates/.default/script.js?16874975349018*/
