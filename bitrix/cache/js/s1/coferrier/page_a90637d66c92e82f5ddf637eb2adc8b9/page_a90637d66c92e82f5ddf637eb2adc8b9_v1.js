...
; /* Start:"a:4:{s:4:"full";s:75:"/local/components/custom/basket/templates/.default/script.js?16874992329929";s:6:"source";s:60:"/local/components/custom/basket/templates/.default/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
BX.ready(function () {
    ...
    const makeOrderBtn = document.querySelector('.basket__info-order-button');
    ...
    makeOrderBtn.addEventListener('click', function () {
        ...
        BX.ajax.runComponentAction(
            ...
            'addNewOrder',
            {
                ...
                if(!response.data){
                    myAlert('упс возникла какая-то ошибка', 'error');
                } else{
                    location.reload();
                }
...
/* End */
;; /* /local/components/custom/basket/templates/.default/script.js?16874992329929*/
