...
; /* Start:"a:4:{s:4:"full";s:76:"/local/components/custom/profile/templates/.default/script.js?16864888043388";s:6:"source";s:61:"/local/components/custom/profile/templates/.default/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
BX.ready(function () {

    const phoneInput = document.getElementById('profile-change-phone');

    phoneInput.addEventListener('input', function() {
        const inputNumber = phoneInput.value.replace(/\D/g, ''); // Удаляем все символы, кроме цифр
        ...
        for (let i = 0; i < pattern.length; i++) {
            if (pattern[i] === '_') {
                if (j < inputNumber.length) {
                    formattedPhoneNumber += inputNumber[j++];
                } else {
                    break;
                }
            } else {
...
/* End */
;; /* /local/components/custom/profile/templates/.default/script.js?16864888043388*/
