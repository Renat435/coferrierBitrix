...
; /* Start:"a:4:{s:4:"full";s:75:"/local/components/custom/basket/templates/.default/script.js?16874816021807";s:6:"source";s:60:"/local/components/custom/basket/templates/.default/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
BX.ready(function () {
    ...
    document.querySelectorAll('.basket__info-list-item').forEach(item => {
        ...
        const price = item.querySelector('.basket__info-list-item-info-price-text > .price');
        const totalPrice = item.querySelector('.basket__info-list-item-info-price-text > .total-price');


        console.log(counter.innerHTML, typeof counter.innerHTML);
    });
...
/* End */
;; /* /local/components/custom/basket/templates/.default/script.js?16874816021807*/
